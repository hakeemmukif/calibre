...
describe("OnboardingPage", () => {
  it("saves the chosen relocation preference and redirects to /feed", async () => {
    updateProfile.mockResolvedValue({ baseCountry: "MY", relocation: "open", updatedAt: "2026-07-14T00:00:00.000Z" });
    render(<OnboardingPage />);

    fireEvent.click(screen.getByText("Open to relocate"));
    fireEvent.click(screen.getByRole("button", { name: /get started/i }));

    await waitFor(() => expect(updateProfile).toHaveBeenCalledWith({ baseCountry: "MY", relocation: "open" }));
