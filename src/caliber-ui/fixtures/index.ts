...
const rawJobs = [
  {
    ...
    eligibility: { tier: "anywhere", tone: "verified", summary: "JD: hires from anywhere" },
  ...
  },
  {
    ...
    eligibility: { tier: "eligible", tone: "good", summary: "remote within SEA" },
  ...
  },
  {
    ...
    eligibility: { tier: "local", tone: "good", summary: "MY board source" },
  ...
  },
  {
    ...
    eligibility: { tier: "unknown", tone: "warn", summary: 'bare "Remote" — employer hiring scope unproven' },
