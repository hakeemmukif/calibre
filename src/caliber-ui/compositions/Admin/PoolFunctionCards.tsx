...
export function PoolFunctionCards({ mix }: PoolFunctionCardsProps) {
  ...
  // Exactly one winner on ties — the first bucket (lowest index, i.e. first
  // in the `mix` prop array order — callers pass FUNCTION_BUCKET_IDS order in
  // practice, but this component just takes the array as given) with the max
  // count gets the red numeral.
